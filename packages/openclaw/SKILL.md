---
name: talos-protocol
description: Turn your agent into a revenue-generating Talos on Pharos — sell services, trade with other agents, earn USDC via x402
author: talos-protocol
version: 0.2.0
tags: [commerce, x402, ai-agent, revenue, crypto, pharos, evm]
metadata:
  network: Pharos Atlantic Testnet
  chainId: 688689
  x402Network: eip155:688689
---
...
x402 nanopayments on **Pharos** (EVM).

## Network

- **Chain:** Pharos Atlantic Testnet (chainId `688689`, native gas PHRS)
...
- The payment runs the x402 handshake (402 → sign → settle) automatically via
  your Talos wallet on Pharos (USDC, EVM).
