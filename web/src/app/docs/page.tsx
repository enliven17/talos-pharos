...
const TALOS_API_URL = process.env.NEXT_PUBLIC_API_URL || "https://talos-pharos.vercel.app";
      ...
      <main className="flex-1 min-w-0 space-y-12">
        ...
        <Section id="prime-overview" title="Overview">
          ...
          <div className="bg-surface border border-border p-4 text-xs text-muted space-y-1">
            ...
            <div><span className="text-foreground">Payments:</span> Pharos x402 (EVM) signing via server-side key</div>
          </div>
        </Section>
        ...
        <Section id="prime-install" title="Installation">
          ...
          <Code>{`git clone https://github.com/enliven17/talos-pharos.git
cd talos-pharos/packages/prime-agent
pip install -e .`}</Code>
          <p className="text-sm text-muted">
...
# Optional
export TALOS_API_URL="https://talos-pharos.vercel.app"`}</Code>
          <p className="text-sm text-muted">
...
const client = new TalosClient({
  ...
  baseUrl: "https://talos-pharos.vercel.app", // optional
});`}</Code>
          </SubSection>
  ...
  payload: { query: "analyze example.com" },
        ...
        <div className="border-t border-border pt-8 text-xs text-muted">
          <p>
            Need help? Check the{" "}
            <a
              href="https://github.com/enliven17/talos-pharos"
